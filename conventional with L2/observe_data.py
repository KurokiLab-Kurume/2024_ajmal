...
# Load .npy file
W = np.load('/l2_wavelet/result_W.npy')
# print("W :",loaded_array1)

l0_norm = np.count_nonzero(W)
# print("W l0 norm:", l0_norm)

Dhr = np.load('/l2_wavelet/result_Dhr.npy')
# print("D_hr :",loaded_array)

Dlr = np.load('/l2_wavelet/result_Dlr.npy')
...
# df_psnr = pd.read_csv("/l2_wavelet/X4_psnr_results.csv")
# # print(df.info())
# print(df_psnr.head())

# df_ssim = pd.read_csv("/l2_wavelet/X4_psnr_results.csv")
# # print(df.info())
# print(df_ssim.head())