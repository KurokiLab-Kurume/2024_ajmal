...
np.save("../l2_wavelet/result_Dlr", D_lr) #saves the result in a .npy file
np.save("../l2_wavelet/result_Xlr", X_lr) 
np.save("../l2_wavelet/result_Dhr", D_hr) 
np.save("../l2_wavelet/result_Xhr", X_hr)
np.save("../l2_wavelet/result_W", W_all)
