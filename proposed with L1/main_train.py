...
lam_coef = 0.001 #regularization parameter (lambda)
lam_map = 0.001
rho_coef = 0.01 #regularization parameter for coefficient optimization (rho)
rho_dict = 0.01 #regularization parameter for dictionary optimization (rho)
rho_map = 0.01
iter_csc = 10
iter_coef = 50
iter_dict = 50
